...
const REQUIRED_UI_KEYS: readonly UiTextKey[] = [
  "admin.common.error.generic",
  "admin.common.error.title",
  "admin.common.loading",
  "admin.roles.actions.delete",
  "admin.roles.actions.delete.confirm",
  "admin.roles.actions.update",
  "admin.roles.actions.update.pending",
  "admin.roles.card.noParents",
  "admin.roles.card.noPermissions",
  "admin.roles.card.parents",
  "admin.roles.card.permissions",
  "admin.roles.create.name",
  "admin.roles.create.submit",
  "admin.roles.create.submit.pending",
  "admin.roles.create.title",
  "admin.roles.list.empty",
  "admin.roles.parents.add",
  "admin.roles.parents.remove",
  "admin.roles.parents.select",
  "admin.roles.permissions.add",
  "admin.roles.permissions.remove",
  "admin.roles.permissions.scope.label",
  "admin.roles.permissions.scope.any",
  "admin.roles.permissions.select",
