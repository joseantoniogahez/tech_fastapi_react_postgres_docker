...
| `VITE_API_BASE_PATH` | API prefix path    | Must be a non-empty string without spaces; normalized to a leading-slash path, and `/` collapses to an empty base path | `/v1`                   |
